...
\lstset{basicstyle=\ttfamily{}\scriptsize{}}
\lstinputlisting[language=CPP,caption=A minimalistic working OpenCL application which calculates the sum vector of two input vectors.,label=lst:opencl_example]{code/sample/main.cpp}
\lstset{basicstyle=\ttfamily{}}
