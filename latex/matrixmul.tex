...
\begin{figure}
	...
	%The chart is based on the benchmark data in appendix chapter \ref{sec:matrix_mul_chart_data}.
	}
...
% and the detailed benchmark results in appendix chapter \ref{sec:matrix_mul_chart_data}.
...
% and the benchmark results in appendix chapter \ref{sec:matrix_mul_chart_data}.
