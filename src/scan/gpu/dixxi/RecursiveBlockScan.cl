...
*/
__kernel void WorkEfficientBlockScan(__global TB* buffer, __global T* sums, __local T* shared)
{
...
__kernel void WorkEfficientBlockScanOptim(__global TB* buffer, __global T* sums, __local T* shared)
{
