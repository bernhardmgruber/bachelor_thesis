...
__kernel void Histogram(__global const uint* data, __global uint* histograms, uint bits)
{
...
__kernel void Permute(__global const uint* src, __global uint* dst, __global const uint* scannedHistograms, uint bits)
{
    size_t globalId = get_global_id(0);
