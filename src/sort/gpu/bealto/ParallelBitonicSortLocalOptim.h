...
namespace gpu
{
    namespace bealto
    {
         ...
         */
        template<typename T>
        class ParallelBitonicSortLocalOptim : public CLAlgorithm<T>, public SortAlgorithm
        {
            public:
                ...
                void init() override
                {
                    Program* program = context->createProgram("gpu/bealto/ParallelBitonicSortLocalOptim.cl", "-D T=" + getTypeName<T>());
