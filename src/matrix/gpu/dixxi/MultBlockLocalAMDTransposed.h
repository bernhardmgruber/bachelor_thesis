...
namespace gpu
{
    ...
    {
        template<typename T>
        class MultBlockLocalAMDTransposed : public CLAlgorithm<T>, public MatrixAlgorithm
        {
        public:
            ...
            {
                return "Matrix multiplication (Blocks and local tiles transposed, dixxi AMD)";
            }
            ...
            void init() override
            {
                    ...
                    Program* program = context->createProgram("gpu/dixxi/MultBlockLocalAMDTransposed.cl", ss.str());
                    kernel = program->createKernel("MultBlockLocalTransposed");
                    delete program;
            }
            ...
            virtual ~MultBlockLocalAMDTransposed() {}
